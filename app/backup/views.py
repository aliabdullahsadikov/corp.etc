...
from app import app
from app.models import News, Notification, Doc, User, Userinfo, db
...
def index():
    ...
    # docs = Doc.query.filter_by(isActive=1).all()
    return render_template('index.html', news=news, documents=docs, notifies=notifies, datetime=datetime.utcnow())
